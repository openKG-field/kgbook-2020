...
funList = []
count = 0
for data in lcol.find({'userid': 'yuanwei', 'fieldsName': '第四范式'}, {'pubid': 1, 'title': 1, 'fieldWords': 1,'techWords':1,
                                                                    'techArea': 1}).batch_size(100):
    if 'techWords' not in data:
        continue
    funList.append(data['techWords'])
...
if __name__ == '__main__':
    dataset = funList #[[1, 3, 4], [2, 3, 5], [1, 2, 3, 5], [2, 5]]       #装入数据 二维列表
